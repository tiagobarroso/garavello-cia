function adjustHeightOfPage(pageNo) {
  ...
  if (pageType != undefined && pageType == "gallery") {
    pageContentHeight = $(
      ".cd-hero-slider li:nth-of-type(" + pageNo + ") .tm-img-gallery-container"
    ).height();
  } else {
    pageContentHeight =
      $(
        ".cd-hero-slider li:nth-of-type(" + pageNo + ") .js-tm-page-content"
      ).height() + 20;
  }
...
$(window).load(function () {
  ...
  let base = $(
    "body > div.cd-hero > div:nth-child(2) > ul > li.selected > div > div > div.tm-img-gallery-container > div > div.grid-item"
  );
